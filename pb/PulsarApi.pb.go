...
type Schema struct {
	...
	Type                 *Schema_Type `protobuf:"varint,4,req,name=type,enum=pulsar.proto.go.Schema_Type" json:"type,omitempty"`
...
type MessageMetadata struct {
	...
	Compression      *CompressionType `protobuf:"varint,8,opt,name=compression,enum=pulsar.proto.go.CompressionType,def=0" json:"compression,omitempty"`
...
type CommandConnect struct {
	...
	AuthMethod      *AuthMethod `protobuf:"varint,2,opt,name=auth_method,json=authMethod,enum=pulsar.proto.go.AuthMethod" json:"auth_method,omitempty"`
...
type KeySharedMeta struct {
	KeySharedMode           *KeySharedMode `protobuf:"varint,1,req,name=keySharedMode,enum=pulsar.proto.go.KeySharedMode" json:"keySharedMode,omitempty"`
...
type CommandSubscribe struct {
	...
	SubType       *CommandSubscribe_SubType `protobuf:"varint,3,req,name=subType,enum=pulsar.proto.go.CommandSubscribe_SubType" json:"subType,omitempty"`
	...
	// or not -- earliest
	InitialPosition *CommandSubscribe_InitialPosition `protobuf:"varint,13,opt,name=initialPosition,enum=pulsar.proto.go.CommandSubscribe_InitialPosition,def=0" json:"initialPosition,omitempty"`
...
type CommandPartitionedTopicMetadataResponse struct {
	...
	RequestId            *uint64                                             `protobuf:"varint,2,req,name=request_id,json=requestId" json:"request_id,omitempty"`
	Response             *CommandPartitionedTopicMetadataResponse_LookupType `protobuf:"varint,3,opt,name=response,enum=pulsar.proto.go.CommandPartitionedTopicMetadataResponse_LookupType" json:"response,omitempty"`
	Error                *ServerError                                        `protobuf:"varint,4,opt,name=error,enum=pulsar.proto.go.ServerError" json:"error,omitempty"`
...
type CommandLookupTopicResponse struct {
	...
	Response            *CommandLookupTopicResponse_LookupType `protobuf:"varint,3,opt,name=response,enum=pulsar.proto.go.CommandLookupTopicResponse_LookupType" json:"response,omitempty"`
	...
	Error               *ServerError                           `protobuf:"varint,6,opt,name=error,enum=pulsar.proto.go.ServerError" json:"error,omitempty"`
...
type CommandProducer struct {
	...
	ProducerAccessMode *ProducerAccessMode `protobuf:"varint,10,opt,name=producer_access_mode,json=producerAccessMode,enum=pulsar.proto.go.ProducerAccessMode,def=0" json:"producer_access_mode,omitempty"`
...
type CommandSendError struct {
	ProducerId           *uint64      `protobuf:"varint,1,req,name=producer_id,json=producerId" json:"producer_id,omitempty"`
	SequenceId           *uint64      `protobuf:"varint,2,req,name=sequence_id,json=sequenceId" json:"sequence_id,omitempty"`
	Error                *ServerError `protobuf:"varint,3,req,name=error,enum=pulsar.proto.go.ServerError" json:"error,omitempty"`
...
type CommandAck struct {
	ConsumerId *uint64             `protobuf:"varint,1,req,name=consumer_id,json=consumerId" json:"consumer_id,omitempty"`
	AckType    *CommandAck_AckType `protobuf:"varint,2,req,name=ack_type,json=ackType,enum=pulsar.proto.go.CommandAck_AckType" json:"ack_type,omitempty"`
	// In case of individual acks, the client can pass a list of message ids
	MessageId            []*MessageIdData            `protobuf:"bytes,3,rep,name=message_id,json=messageId" json:"message_id,omitempty"`
	ValidationError      *CommandAck_ValidationError `protobuf:"varint,4,opt,name=validation_error,json=validationError,enum=pulsar.proto.go.CommandAck_ValidationError" json:"validation_error,omitempty"`
...
type CommandError struct {
	RequestId            *uint64      `protobuf:"varint,1,req,name=request_id,json=requestId" json:"request_id,omitempty"`
	Error                *ServerError `protobuf:"varint,2,req,name=error,enum=pulsar.proto.go.ServerError" json:"error,omitempty"`
...
type CommandConsumerStatsResponse struct {
	RequestId    *uint64      `protobuf:"varint,1,req,name=request_id,json=requestId" json:"request_id,omitempty"`
	ErrorCode    *ServerError `protobuf:"varint,2,opt,name=error_code,json=errorCode,enum=pulsar.proto.go.ServerError" json:"error_code,omitempty"`
...
type CommandGetTopicsOfNamespace struct {
	...
	Mode                 *CommandGetTopicsOfNamespace_Mode `protobuf:"varint,3,opt,name=mode,enum=pulsar.proto.go.CommandGetTopicsOfNamespace_Mode,def=0" json:"mode,omitempty"`
...
type CommandTcClientConnectResponse struct {
	RequestId            *uint64      `protobuf:"varint,1,req,name=request_id,json=requestId" json:"request_id,omitempty"`
	Error                *ServerError `protobuf:"varint,2,opt,name=error,enum=pulsar.proto.go.ServerError" json:"error,omitempty"`
...
type CommandEndTxn struct {
	...
	TxnidLeastBits       *uint64    `protobuf:"varint,2,opt,name=txnid_least_bits,json=txnidLeastBits,def=0" json:"txnid_least_bits,omitempty"`
	TxnidMostBits        *uint64    `protobuf:"varint,3,opt,name=txnid_most_bits,json=txnidMostBits,def=0" json:"txnid_most_bits,omitempty"`
	TxnAction            *TxnAction `protobuf:"varint,4,opt,name=txn_action,json=txnAction,enum=pulsar.proto.go.TxnAction" json:"txn_action,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
type CommandEndTxnOnPartition struct {
	...
	TxnAction                    *TxnAction `protobuf:"varint,5,opt,name=txn_action,json=txnAction,enum=pulsar.proto.go.TxnAction" json:"txn_action,omitempty"`
...
type BaseCommand struct {
	Type                            *BaseCommand_Type                        `protobuf:"varint,1,req,name=type,enum=pulsar.proto.go.BaseCommand_Type" json:"type,omitempty"`
...
func init() {
	proto.RegisterEnum("pulsar.proto.go.CompressionType", CompressionType_name, CompressionType_value)
	proto.RegisterEnum("pulsar.proto.go.ProducerAccessMode", ProducerAccessMode_name, ProducerAccessMode_value)
	proto.RegisterEnum("pulsar.proto.go.ServerError", ServerError_name, ServerError_value)
	proto.RegisterEnum("pulsar.proto.go.AuthMethod", AuthMethod_name, AuthMethod_value)
	proto.RegisterEnum("pulsar.proto.go.ProtocolVersion", ProtocolVersion_name, ProtocolVersion_value)
	proto.RegisterEnum("pulsar.proto.go.KeySharedMode", KeySharedMode_name, KeySharedMode_value)
	proto.RegisterEnum("pulsar.proto.go.TxnAction", TxnAction_name, TxnAction_value)
	proto.RegisterEnum("pulsar.proto.go.Schema_Type", Schema_Type_name, Schema_Type_value)
	proto.RegisterEnum("pulsar.proto.go.CommandSubscribe_SubType", CommandSubscribe_SubType_name, CommandSubscribe_SubType_value)
	proto.RegisterEnum("pulsar.proto.go.CommandSubscribe_InitialPosition", CommandSubscribe_InitialPosition_name, CommandSubscribe_InitialPosition_value)
	proto.RegisterEnum("pulsar.proto.go.CommandPartitionedTopicMetadataResponse_LookupType", CommandPartitionedTopicMetadataResponse_LookupType_name, CommandPartitionedTopicMetadataResponse_LookupType_value)
	proto.RegisterEnum("pulsar.proto.go.CommandLookupTopicResponse_LookupType", CommandLookupTopicResponse_LookupType_name, CommandLookupTopicResponse_LookupType_value)
	proto.RegisterEnum("pulsar.proto.go.CommandAck_AckType", CommandAck_AckType_name, CommandAck_AckType_value)
	proto.RegisterEnum("pulsar.proto.go.CommandAck_ValidationError", CommandAck_ValidationError_name, CommandAck_ValidationError_value)
	proto.RegisterEnum("pulsar.proto.go.CommandGetTopicsOfNamespace_Mode", CommandGetTopicsOfNamespace_Mode_name, CommandGetTopicsOfNamespace_Mode_value)
	proto.RegisterEnum("pulsar.proto.go.BaseCommand_Type", BaseCommand_Type_name, BaseCommand_Type_value)
	proto.RegisterType((*Schema)(nil), "pulsar.proto.go.Schema")
	proto.RegisterType((*MessageIdData)(nil), "pulsar.proto.go.MessageIdData")
	proto.RegisterType((*KeyValue)(nil), "pulsar.proto.go.KeyValue")
	proto.RegisterType((*KeyLongValue)(nil), "pulsar.proto.go.KeyLongValue")
	proto.RegisterType((*IntRange)(nil), "pulsar.proto.go.IntRange")
	proto.RegisterType((*EncryptionKeys)(nil), "pulsar.proto.go.EncryptionKeys")
	proto.RegisterType((*MessageMetadata)(nil), "pulsar.proto.go.MessageMetadata")
	proto.RegisterType((*SingleMessageMetadata)(nil), "pulsar.proto.go.SingleMessageMetadata")
	proto.RegisterType((*BrokerEntryMetadata)(nil), "pulsar.proto.go.BrokerEntryMetadata")
	proto.RegisterType((*CommandConnect)(nil), "pulsar.proto.go.CommandConnect")
	proto.RegisterType((*FeatureFlags)(nil), "pulsar.proto.go.FeatureFlags")
	proto.RegisterType((*CommandConnected)(nil), "pulsar.proto.go.CommandConnected")
	proto.RegisterType((*CommandAuthResponse)(nil), "pulsar.proto.go.CommandAuthResponse")
	proto.RegisterType((*CommandAuthChallenge)(nil), "pulsar.proto.go.CommandAuthChallenge")
	proto.RegisterType((*AuthData)(nil), "pulsar.proto.go.AuthData")
	proto.RegisterType((*KeySharedMeta)(nil), "pulsar.proto.go.KeySharedMeta")
	proto.RegisterType((*CommandSubscribe)(nil), "pulsar.proto.go.CommandSubscribe")
	proto.RegisterType((*CommandPartitionedTopicMetadata)(nil), "pulsar.proto.go.CommandPartitionedTopicMetadata")
	proto.RegisterType((*CommandPartitionedTopicMetadataResponse)(nil), "pulsar.proto.go.CommandPartitionedTopicMetadataResponse")
	proto.RegisterType((*CommandLookupTopic)(nil), "pulsar.proto.go.CommandLookupTopic")
	proto.RegisterType((*CommandLookupTopicResponse)(nil), "pulsar.proto.go.CommandLookupTopicResponse")
	proto.RegisterType((*CommandProducer)(nil), "pulsar.proto.go.CommandProducer")
	proto.RegisterType((*CommandSend)(nil), "pulsar.proto.go.CommandSend")
	proto.RegisterType((*CommandSendReceipt)(nil), "pulsar.proto.go.CommandSendReceipt")
	proto.RegisterType((*CommandSendError)(nil), "pulsar.proto.go.CommandSendError")
	proto.RegisterType((*CommandMessage)(nil), "pulsar.proto.go.CommandMessage")
	proto.RegisterType((*CommandAck)(nil), "pulsar.proto.go.CommandAck")
	proto.RegisterType((*CommandAckResponse)(nil), "pulsar.proto.go.CommandAckResponse")
	proto.RegisterType((*CommandActiveConsumerChange)(nil), "pulsar.proto.go.CommandActiveConsumerChange")
	proto.RegisterType((*CommandFlow)(nil), "pulsar.proto.go.CommandFlow")
	proto.RegisterType((*CommandUnsubscribe)(nil), "pulsar.proto.go.CommandUnsubscribe")
	proto.RegisterType((*CommandSeek)(nil), "pulsar.proto.go.CommandSeek")
	proto.RegisterType((*CommandReachedEndOfTopic)(nil), "pulsar.proto.go.CommandReachedEndOfTopic")
	proto.RegisterType((*CommandCloseProducer)(nil), "pulsar.proto.go.CommandCloseProducer")
	proto.RegisterType((*CommandCloseConsumer)(nil), "pulsar.proto.go.CommandCloseConsumer")
	proto.RegisterType((*CommandRedeliverUnacknowledgedMessages)(nil), "pulsar.proto.go.CommandRedeliverUnacknowledgedMessages")
	proto.RegisterType((*CommandSuccess)(nil), "pulsar.proto.go.CommandSuccess")
	proto.RegisterType((*CommandProducerSuccess)(nil), "pulsar.proto.go.CommandProducerSuccess")
	proto.RegisterType((*CommandError)(nil), "pulsar.proto.go.CommandError")
	proto.RegisterType((*CommandPing)(nil), "pulsar.proto.go.CommandPing")
	proto.RegisterType((*CommandPong)(nil), "pulsar.proto.go.CommandPong")
	proto.RegisterType((*CommandConsumerStats)(nil), "pulsar.proto.go.CommandConsumerStats")
	proto.RegisterType((*CommandConsumerStatsResponse)(nil), "pulsar.proto.go.CommandConsumerStatsResponse")
	proto.RegisterType((*CommandGetLastMessageId)(nil), "pulsar.proto.go.CommandGetLastMessageId")
	proto.RegisterType((*CommandGetLastMessageIdResponse)(nil), "pulsar.proto.go.CommandGetLastMessageIdResponse")
	proto.RegisterType((*CommandGetTopicsOfNamespace)(nil), "pulsar.proto.go.CommandGetTopicsOfNamespace")
	proto.RegisterType((*CommandGetTopicsOfNamespaceResponse)(nil), "pulsar.proto.go.CommandGetTopicsOfNamespaceResponse")
	proto.RegisterType((*CommandWatchTopicList)(nil), "pulsar.proto.go.CommandWatchTopicList")
	proto.RegisterType((*CommandWatchTopicListSuccess)(nil), "pulsar.proto.go.CommandWatchTopicListSuccess")
	proto.RegisterType((*CommandWatchTopicUpdate)(nil), "pulsar.proto.go.CommandWatchTopicUpdate")
	proto.RegisterType((*CommandWatchTopicListClose)(nil), "pulsar.proto.go.CommandWatchTopicListClose")
	proto.RegisterType((*CommandGetSchema)(nil), "pulsar.proto.go.CommandGetSchema")
	proto.RegisterType((*CommandGetSchemaResponse)(nil), "pulsar.proto.go.CommandGetSchemaResponse")
	proto.RegisterType((*CommandGetOrCreateSchema)(nil), "pulsar.proto.go.CommandGetOrCreateSchema")
	proto.RegisterType((*CommandGetOrCreateSchemaResponse)(nil), "pulsar.proto.go.CommandGetOrCreateSchemaResponse")
	proto.RegisterType((*CommandTcClientConnectRequest)(nil), "pulsar.proto.go.CommandTcClientConnectRequest")
	proto.RegisterType((*CommandTcClientConnectResponse)(nil), "pulsar.proto.go.CommandTcClientConnectResponse")
	proto.RegisterType((*CommandNewTxn)(nil), "pulsar.proto.go.CommandNewTxn")
	proto.RegisterType((*CommandNewTxnResponse)(nil), "pulsar.proto.go.CommandNewTxnResponse")
	proto.RegisterType((*CommandAddPartitionToTxn)(nil), "pulsar.proto.go.CommandAddPartitionToTxn")
	proto.RegisterType((*CommandAddPartitionToTxnResponse)(nil), "pulsar.proto.go.CommandAddPartitionToTxnResponse")
	proto.RegisterType((*Subscription)(nil), "pulsar.proto.go.Subscription")
	proto.RegisterType((*CommandAddSubscriptionToTxn)(nil), "pulsar.proto.go.CommandAddSubscriptionToTxn")
	proto.RegisterType((*CommandAddSubscriptionToTxnResponse)(nil), "pulsar.proto.go.CommandAddSubscriptionToTxnResponse")
	proto.RegisterType((*CommandEndTxn)(nil), "pulsar.proto.go.CommandEndTxn")
	proto.RegisterType((*CommandEndTxnResponse)(nil), "pulsar.proto.go.CommandEndTxnResponse")
	proto.RegisterType((*CommandEndTxnOnPartition)(nil), "pulsar.proto.go.CommandEndTxnOnPartition")
	proto.RegisterType((*CommandEndTxnOnPartitionResponse)(nil), "pulsar.proto.go.CommandEndTxnOnPartitionResponse")
	proto.RegisterType((*CommandEndTxnOnSubscription)(nil), "pulsar.proto.go.CommandEndTxnOnSubscription")
	proto.RegisterType((*CommandEndTxnOnSubscriptionResponse)(nil), "pulsar.proto.go.CommandEndTxnOnSubscriptionResponse")
	proto.RegisterType((*BaseCommand)(nil), "pulsar.proto.go.BaseCommand")
}

func init() { proto.RegisterFile("PulsarApi.proto", fileDescriptor_39529ba7ad9caeb8) }

var fileDescriptor_39529ba7ad9caeb8 = []byte{
	// 6806 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *CommandProducer) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitialSubscriptionName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *CommandConsumerStatsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field MessageAckRate", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
...
func (m *CommandGetTopicsOfNamespace) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TopicsPattern", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TopicsHash", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *CommandWatchTopicList) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommandWatchTopicList: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommandWatchTopicList: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WatcherId", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
	...
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("watcher_id")
	}
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("namespace")
	}
	if hasFields[0]&uint64(0x00000008) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("topics_pattern")
	}
...
func (m *CommandWatchTopicListSuccess) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommandWatchTopicListSuccess: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommandWatchTopicListSuccess: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
	...
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("topics_hash")
	}
...
func (m *CommandWatchTopicUpdate) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommandWatchTopicUpdate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommandWatchTopicUpdate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NewTopics", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NewTopics = append(m.NewTopics, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeletedTopics", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DeletedTopics = append(m.DeletedTopics, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TopicsHash", wireType)
...
func (m *CommandWatchTopicListClose) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommandWatchTopicListClose: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommandWatchTopicListClose: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *BaseCommand) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 64:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WatchTopicList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WatchTopicList == nil {
				m.WatchTopicList = &CommandWatchTopicList{}
			}
			if err := m.WatchTopicList.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 65:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WatchTopicListSuccess", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WatchTopicListSuccess == nil {
				m.WatchTopicListSuccess = &CommandWatchTopicListSuccess{}
			}
			if err := m.WatchTopicListSuccess.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 66:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WatchTopicUpdate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WatchTopicUpdate == nil {
				m.WatchTopicUpdate = &CommandWatchTopicUpdate{}
			}
			if err := m.WatchTopicUpdate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 67:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WatchTopicListClose", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WatchTopicListClose == nil {
				m.WatchTopicListClose = &CommandWatchTopicListClose{}
			}
			if err := m.WatchTopicListClose.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
